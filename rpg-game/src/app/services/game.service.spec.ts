...
describe('GameService', () => {
  ...
  beforeEach(() => {
    ...
    // displayService = new DisplayService(loggerService); //({log: () => {}}) mockolás
  ...
  describe('An attack event', () => {
    ...
    it("should be randomized by the RanodmService", () => {
    ...
    it('should log by the logger', () => {
      ...
      // spyOn(displayService, 'addHistoryEvent'); //kimockoljuk ezt az adatot, hogy ezt ne logolja ki nekünk, csak a 39-es sort logolja
