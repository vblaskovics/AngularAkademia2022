...
import { interval, map, Observable, Subject, filter } from 'rxjs';
...
export class StateService {
  ...
  constructor() {
    ...
    // filter igaz vagy hamissal tér vissza, az itteni return az igaz eset. Az egész csak akkor működik, ha .subscribe is van a végén!
    this.counter$
      .pipe(
        filter((counter) => {
          return counter === 0;
