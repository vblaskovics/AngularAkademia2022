...
describe("GameService", () => {
    ...
    beforeEach(() => {
        ...
        randomServiceSpy.onRandomPoint.and.returnValue(1);
        ...
        TestBed.configureTestingModule({
            providers: [
                ...
                // { provide: RandomService, useValue: { onRandomPoint: () => 1 } },
                GameService,
            ]
        });
    ...
    describe("An attack event", () => {
        ...
        it("should be randomized by the RandomService", () => {
            ...
            expect(randomService.onRandomPoint).toHaveBeenCalledTimes(2);
        });
